 ...
 */
class Version20180423073748 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(254) NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(25) NOT NULL, second_name VARCHAR(25) DEFAULT NULL, is_active TINYINT(1) NOT NULL, role VARCHAR(25) NOT NULL, UNIQUE INDEX UNIQ_8D93D649BF396750 (id), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
